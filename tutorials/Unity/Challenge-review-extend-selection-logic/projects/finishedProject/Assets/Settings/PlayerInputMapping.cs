...
public class PlayerInputMapping : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ...
                    ""type"": ""Button"",
                    ""id"": ""8a0b4b34-7098-4374-b917-905bb3f812e1"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                },
                {
                    ""name"": ""Player_Select"",
                    ""type"": ""Button"",
                    ""id"": ""bd4e3c9c-f7d5-4fc5-ae93-a964e5589d3d"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""c492897c-d862-4f94-ae5e-c7a2b6a344df"",
                ...
                {
                    ""name"": """",
                    ""id"": ""29cf06bf-e80b-4e4d-af4e-b4b0b005bf3f"",
                ...
                {
                    ""name"": """",
                    ""id"": ""9c2b9fc7-4489-4fd8-af1f-d9ca9c898945"",
    ...
    ""controlSchemes"": []
        ...
        m_Player_Player_Select = m_Player.FindAction("Player_Select", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Player_Player_Select;
    public struct PlayerActions
    {
        ...
        public InputAction @Player_Select => m_Wrapper.m_Player_Player_Select;
        ...
        public void SetCallbacks(IPlayerActions instance)
        {
            if (m_Wrapper.m_PlayerActionsCallbackInterface != null)
            {
                ...
                Player_Deselect.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnPlayer_Deselect;
                Player_Deselect.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnPlayer_Deselect;
                Player_Deselect.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnPlayer_Deselect;
                Player_Select.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnPlayer_Select;
                Player_Select.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnPlayer_Select;
                Player_Select.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnPlayer_Select;
            }
            ...
            if (instance != null)
            {
                ...
                Player_Select.started += instance.OnPlayer_Select;
                Player_Select.performed += instance.OnPlayer_Select;
                Player_Select.canceled += instance.OnPlayer_Select;
            }
        }
    }
    ...
    public interface IPlayerActions
    {
        ...
        void OnPlayer_Select(InputAction.CallbackContext context);
    }
}
